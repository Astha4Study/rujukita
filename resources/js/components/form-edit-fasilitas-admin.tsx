...
interface FormEditFasilitasAdminProps {
    data: any;
...
const FormEditFasilitasAdmin: React.FC<FormEditFasilitasAdminProps> = ({
    data,
    setData,
    handleSubmit,
    handleChangeFile,
        ...
        >
            ...
            <div>
                ...
                <select
                    ...
                    className="w-full rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-700 transition focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20"
                >
...
export default FormEditFasilitasAdmin;
