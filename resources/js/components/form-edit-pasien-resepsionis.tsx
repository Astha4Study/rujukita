...
interface FormEditPasienResepsionisProps {
    data: any;
...
const FormEditPasienResepsionis: React.FC<FormEditPasienResepsionisProps> = ({
    data,
    setData,
    handleSubmit,
    processing,
...
export default FormEditPasienResepsionis;
